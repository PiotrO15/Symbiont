...
public class CellEditorMenu extends AbstractContainerMenu {
    private final CellEditorBlockEntity blockEntity;

    public CellEditorMenu(int id, Inventory playerInv, BlockPos pos) {
        super(ModMenuTypes.CELL_EDITOR.get(), id);
        CellEditorBlockEntity be = playerInv.player.level().getBlockEntity(pos) instanceof CellEditorBlockEntity ? (CellEditorBlockEntity) playerInv.player.level().getBlockEntity(pos) : null;
