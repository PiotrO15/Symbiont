...
public class MetabolizerRecipeBuilder {
    ...
    public MetabolizerRecipeBuilder(NonNullList<Ingredient> itemInput, SizedFluidIngredient fluidInput, ItemStack itemOutput, FluidStack fluidOutput) {
    ...
    public static MetabolizerRecipeBuilder newRecipe(NonNullList<Ingredient> itemInput, SizedFluidIngredient fluidInput, ItemStack itemOutput, FluidStack fluidOutput) {
